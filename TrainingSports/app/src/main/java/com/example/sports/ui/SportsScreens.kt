...
fun SportsApp(
    ...
    Scaffold(
        topBar = {
            SportsAppBar(
                isShowingListPage =
                if(contentType == SportsContentType.ListOnly) uiState.isShowingListPage else true,
        ...
        SportsList(
            ...
            modifier = Modifier
                ...
                .padding(
                    ...
                    bottom = contentPadding.calculateBottomPadding() + dimensionResource(id = R.dimen.padding_medium)
                )
        )
